    ...
    <div>
      <section className="py-8 bg-neutral-100 mb-40">
        ...
        <p className="text-center m-4 text-sm text-black sm:text-base md:mb-12 lg:mb-16 animate-fade-in-up delay-100">
          Join Shazia Samma! From foundational concepts to advanced techniques,
          this blog is packed with insights to empower aspiring developers.
        </p>
        <div className="mx-auto max-w-7xl px-5">
          <h1 className="text-3xl font-bold text-center my-8 text-cyan-900 animate-color-change">
            Exploring Our Categories
          </h1>
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-6 animate-fade-in-up delay-100">
            {categories.map((category, index) => (
              <div
                key={index}  // Use index here instead of uuidv4()
              ...
              >
                <div className="text-center text-lg font-semibold relative">
                  <p>{category}</p>
